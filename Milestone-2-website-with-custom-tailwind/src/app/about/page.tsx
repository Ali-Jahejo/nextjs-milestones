export default function AboutUs() {
  ...
  <div className="flex flex-col items-center bg-gray-100 py-10">
      <h2 className="text-blue-600 text-3xl font-bold py-4">About M.A</h2>
      <main className="text-gray-900 w-4/5  rounded border border-gray-200 p-4 shadow-xl">
      
      <section>
      
        <p>
          Welcome to M . A—your trusted platform for high-quality, flexible,
          and impactful online education. At M . A, we believe that
      ...
      <section>
        ...
        <p>
          M . A was founded with a simple but powerful vision: to
          ...
          make M . A a place where learners can transform their passions
      ...
      <section>
        ...
        <p>
          <span>Quality:</span>Every course on M . A is created by industry
      ...
      <section>
        ...
        <p>
          At M . A, our vision is to create a world where learning is
      ...
      <br />
      <br />
      <h2 className="text-blue-600 text-2xl py-4">Start your journey with M . A, where learning meets opportunity!</h2>
    </main>
  </div>
  );
}
